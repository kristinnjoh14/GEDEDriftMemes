...
ACPlusPlusDriftTestHud::ACPlusPlusDriftTestHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void ACPlusPlusDriftTestHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if( bHMDDeviceActive == false )
	{
		...
		ACPlusPlusDriftTestPawn* Vehicle = Cast<ACPlusPlusDriftTestPawn>(GetOwningPawn());
